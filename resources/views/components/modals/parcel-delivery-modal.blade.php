<!-- Parcel Delivery Booking Modal -->
<div id="parcel-delivery-modal" class="fixed inset-0 z-50 hidden overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-3 py-4">
        ...
        <div class="relative inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-6 sm:align-middle sm:max-w-5xl sm:w-full max-h-[90vh] overflow-y-auto border-2 border-white/20 backdrop-blur-sm"
            style="box-shadow: 0 20px 40px -10px rgba(0, 0, 0, 0.25), 0 0 0 1px rgba(255, 255, 255, 0.1)">

            <!-- Modal Header -->
            <div class="bg-gradient-to-r from-orange-600 to-red-700 px-6 py-4 sticky top-0 z-10 shadow-lg">
            ...
            <form id="parcel-delivery-form" class="px-6 py-5">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    <div
                        class="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-5 border border-orange-200 shadow-md">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <select id="parcel_pickup_city" name="pickup_city_id"
                                        class="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-orange-600 focus:border-orange-600"
                                        required>
                            ...
                            <div>
                                <label for="parcel_type" class="block text-xs font-semibold text-gray-700 mb-1.5">
                                ...
                                <p class="text-xs text-gray-500 mt-1">Choose based on package size and weight</p>
                            ...
                            <!-- Parcel Weight -->
                            <div>
                                <label for="parcel_weight" class="block text-xs font-semibold text-gray-700 mb-1.5">
                                    Parcel Weight (kg) <span class="text-red-500">*</span>
                                </label>
                                <input type="number" id="parcel_weight" name="parcel_weight" step="0.1" min="0.1"
                                    class="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-orange-600 focus:border-orange-600"
                                    placeholder="0.0" required>
                                <p class="text-xs text-gray-500 mt-1">Weight must be within parcel type limits</p>
                            </div>

                            <!-- Delivery Date and Time -->
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div>
                                    <label for="parcel_pickup_date"
                                        class="block text-xs font-semibold text-gray-700 mb-1.5">
                        ...
                        <!-- Price Display -->
                        <div id="parcel-price-display"
                            class="hidden mt-4 p-3 bg-gradient-to-br from-orange-50 to-red-50 border border-orange-200 rounded-lg">
                            <div class="flex items-center mb-2">
                                ...
                                <h5 class="text-xs font-bold text-orange-800">Delivery Pricing</h5>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-700">Total Price:</span>
                                <span id="parcel-price-amount" class="text-lg font-bold text-orange-600"></span>
                            </div>
                            <div id="parcel-price-breakdown" class="text-xs text-gray-600 mt-1">
                                <!-- Price breakdown will be shown here -->
                            </div>
                        </div>
                        
                        <!-- Admin Configuration Notice -->
                        <div id="parcel-config-notice" class="hidden mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <div
                        class="bg-gradient-to-br from-red-50 to-pink-50 rounded-xl p-5 border border-red-200 shadow-md">
                        <h4 class="text-base font-bold text-gray-800 mb-4 flex items-center">
                        ...
                        <div class="space-y-4">
                            <!-- Sender Information -->
                            <div
                                class="bg-white/50 p-3 rounded-lg border border-red-100">
                                <h5 class="text-sm font-semibold text-gray-800 mb-3">Sender Information</h5>
                                <div class="space-y-3">
                                    <div>
                                        <label for="parcel_customer_name"
                                        ...
                                        <input type="text" id="parcel_customer_name" name="customer_name"
                                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-red-600 focus:border-red-600"
                                            required>
                                    </div>

                                    <div>
                                        <label for="parcel_customer_email"
                                            class="block text-xs font-semibold text-gray-700 mb-1">
                                        ...
                                        <input type="email" id="parcel_customer_email" name="customer_email"
                                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-red-600 focus:border-red-600"
                                            required>
                                        <p class="text-xs text-gray-500 mt-1">For account and tracking updates</p>
                                    </div>

                                    <div>
                                        <label for="parcel_customer_phone"
                                            class="block text-xs font-semibold text-gray-700 mb-1">
                            ...
                            <div
                                class="bg-white/50 p-3 rounded-lg border border-red-100">
                                <h5 class="text-sm font-semibold text-gray-800 mb-3">Recipient Information</h5>
                                <div class="space-y-3">
                                    <div>
                    ...
                    <div
                        class="bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-5 border border-pink-200 shadow-md">
                        <h4 class="text-base font-bold text-gray-800 mb-4 flex items-center">
                        ...
                        <div class="space-y-4">
                            <!-- Account Password -->
                            <div
                                class="bg-white/50 p-3 rounded-lg border border-pink-100">
                                <h5 class="text-sm font-semibold text-gray-800 mb-3">Account Setup</h5>
                                <div class="space-y-3">
                                    <div>
                                        <label for="parcel_password"
                                            class="block text-xs font-semibold text-gray-700 mb-1">
                                            Password <span class="text-red-500">*</span>
                                        </label>
                                        <input type="password" id="parcel_password" name="password"
                                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-pink-600 focus:border-pink-600"
                                            required minlength="4">
                                        <p class="text-xs text-gray-500 mt-1">Minimum 4 characters</p>
                                    </div>

                                    <div>
                                        <label for="parcel_password_confirmation"
                                            class="block text-xs font-semibold text-gray-700 mb-1">
                                            Confirm Password <span class="text-red-500">*</span>
                                        </label>
                                        <input type="password" id="parcel_password_confirmation"
                            ...
                            <div
                                class="bg-white/50 p-3 rounded-lg border border-pink-100">
                                <h5 class="text-sm font-semibold text-gray-800 mb-3">Delivery Options</h5>
                                <div class="space-y-3">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="urgent_delivery" value="1"
                                            class="rounded border-gray-300 text-pink-600 focus:ring-pink-500">
                                        <span class="ml-2 text-xs font-medium text-gray-700">Urgent Delivery (+50%)</span>
                                    </label>
                                    <p class="text-xs text-gray-500">Priority handling and same-day delivery</p>

                                    <label class="flex items-center">
                                        <input type="checkbox" name="signature_required" value="1"
                                            class="rounded border-gray-300 text-pink-600 focus:ring-pink-500">
                                        <span class="ml-2 text-xs font-medium text-gray-700">Signature Required</span>
                                    </label>
                                    <p class="text-xs text-gray-500">Recipient must sign for delivery</p>

                                    <label class="flex items-center">
                                        <input type="checkbox" name="insurance_required" value="1"
                                            class="rounded border-gray-300 text-pink-600 focus:ring-pink-500">
                                        <span class="ml-2 text-xs font-medium text-gray-700">Insurance Coverage (+2%)</span>
                                    </label>
                                    <p class="text-xs text-gray-500">Protection against loss or damage</p>
                                </div>
                            </div>
                        ...
                        <!-- Delivery Benefits -->
                        <div
                            class="mt-4 p-3 bg-gradient-to-br from-pink-50 to-purple-50 border border-pink-200 rounded-lg">
                            <div class="flex items-center mb-2">
                                <div class="p-1.5 bg-pink-100 rounded mr-2 border border-pink-200">
                                ...
                                <h5 class="text-xs font-bold text-pink-800">Delivery Benefits</h5>
                            </div>
                ...
                <div class="mt-6 flex items-center justify-end space-x-3 pt-5 border-t border-gray-200">
                    <button type="button" id="cancel-parcel-booking"
                    ...
                    <button type="submit"
                        class="px-8 py-2.5 bg-gradient-to-r from-orange-600 to-red-700 text-white rounded-lg hover:from-red-700 hover:to-orange-600 transition-all duration-200 transform hover:scale-105 shadow-md font-medium text-sm">
