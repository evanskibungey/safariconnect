    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Update airport information</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.transportation.airports.update', $airport) }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="Additional information about the airport (optional)">{{ old('description', $airport->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
