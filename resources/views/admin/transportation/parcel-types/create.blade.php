        ...
        <div class="flex items-center">
            ...
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Add New Parcel Type') }}
                </h2>
                <p class="text-gray-600 mt-1">Create a new parcel category for delivery services</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.transportation.parcel-types.store') }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="Describe this parcel type...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-2 text-sm text-blue-700">
                                    <p>Parcel types are used in delivery service pricing rules to categorize packages by size and weight. Examples:</p>
                                    <ul class="list-disc list-inside mt-2 space-y-1">
                                        <li><strong>Documents:</strong> Max 0.5kg, 30x25x5 cm</li>
                                        <li><strong>Small Package:</strong> Max 5kg, 40x30x20 cm</li>
                                        <li><strong>Medium Package:</strong> Max 15kg, 60x40x30 cm</li>
                                        <li><strong>Large Package:</strong> Max 30kg, 80x60x40 cm</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
