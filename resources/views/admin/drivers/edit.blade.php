                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="license_expiry" id="license_expiry" value="{{ old('license_expiry', $driver->license_expiry->format('Y-m-d')) }}" required
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="vehicle_type_id" id="vehicle_type_id" required
                                ...
                                @foreach($vehicleTypes as $id => $name)
                                    <option value="{{ $id }}" {{ old('vehicle_type_id', $driver->vehicle_type_id) == $id ? 'selected' : '' }}>{{ $name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="vehicle_registration" id="vehicle_registration" value="{{ old('vehicle_registration', $driver->vehicle_registration) }}" required
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="vehicle_make" id="vehicle_make" value="{{ old('vehicle_make', $driver->vehicle_make) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="vehicle_model" id="vehicle_model" value="{{ old('vehicle_model', $driver->vehicle_model) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="vehicle_year" id="vehicle_year" value="{{ old('vehicle_year', $driver->vehicle_year) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="vehicle_color" id="vehicle_color" value="{{ old('vehicle_color', $driver->vehicle_color) }}"
                    ...
                    <div class="space-y-4">
                        @if($driver->agreement_document)
                            <div class="border rounded-lg p-4 bg-gray-50">
                                <p class="text-sm font-medium text-gray-700 mb-2">Current Agreement Document:</p>
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-xs text-gray-500">
                                        Uploaded {{ $driver->agreement_date ? $driver->agreement_date->format('M d, Y') : 'N/A' }}
                                    </span>
                                </div>
                            </div>
                        @endif
                        ...
                        <div>
                            <label for="agreement_document" class="block text-sm font-medium text-gray-700">
                                {{ $driver->agreement_document ? 'Replace Agreement Document' : 'Agreement Document (Optional)' }}
                            </label>
                        ...
                        <div>
                            ...
                            <input type="date" name="agreement_date" id="agreement_date" 
                                value="{{ old('agreement_date', $driver->agreement_date?->format('Y-m-d')) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="4"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            placeholder="Any additional information about the driver...">{{ old('notes', $driver->notes) }}</textarea>
                    </div>
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-4">
                        <div class="border rounded-lg p-3 bg-gray-50">
                            ...
                            <p class="text-lg font-semibold text-gray-800">{{ $driver->total_trips }}</p>
                        </div>
                        <div class="border rounded-lg p-3 bg-gray-50">
                            <p class="text-xs text-gray-500">Rating</p>
                            <p class="text-lg font-semibold text-gray-800">{{ $driver->rating_display }}</p>
                        </div>
                    </div>
                </div>
            </div>
